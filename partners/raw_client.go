...
func (r *RawClient) PostV1PartnersFilesList(
	...
	endpointURL := baseURL + "/v1/partners/files/list"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
...
func (r *RawClient) RemindersTheOvernightDebtReminderJobWouldSendTodayForThisCompany(
	...
	endpointURL := baseURL + "/v1/partners/debt-reminders/preview"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
...
func (r *RawClient) PostV1PartnersDebtRemindersList(
	...
	endpointURL := baseURL + "/v1/partners/debt-reminders/list"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
...
func (r *RawClient) PostV1PartnersVatReviewsList(
	...
	endpointURL := baseURL + "/v1/partners/vat-reviews/list"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
...
func (r *RawClient) PostV1PartnersVatReviewsResolve(
	...
	endpointURL := baseURL + "/v1/partners/vat-reviews/resolve"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
